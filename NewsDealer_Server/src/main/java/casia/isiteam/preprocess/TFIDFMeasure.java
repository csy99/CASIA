...
public class TFIDFMeasure {
    private ArrayList<ArrayList<String>> fileContent; // 文档内容
    ...
    public TFIDFMeasure(ArrayList<ArrayList<String>> fileContent) {
    ...
    private void GenerateTermFrequency() {
        for (int i = 0; i < fileContent.size(); i++) {
            String[] curDoc = (String[]) fileContent.get(i).toArray(new String[0]);
     ...
     * @return
     */
    private ArrayList<String> GenerateTerms(ArrayList<ArrayList<String>> fileContent) {
        ArrayList<String> uniques = new ArrayList<String>();
        for (int i = 0; i < fileContent.size(); i++) {
            ArrayList<String> tmp = fileContent.get(i);
            for (int j = 0; j < tmp.size(); j++)
                if (!uniques.contains(tmp.get(j)))
                    uniques.add(tmp.get(j));
        }
        return uniques;
    }
